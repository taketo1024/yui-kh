...
#[test]
#[ignore]
// cargo test -r -- --exact knotJ_interlock_divided_no_elim --nocapture --include-ignored
fn knotJ_interlock_divided_no_elim() { 
    init_logger();
    ...
    let l = InvLink::sinv_knot_from_code([
        ...
        // lower 37..60
        [34,72,35,71],[36,63,37,64],[37,43,38,42],[44,77,45,78],[45,61,46,60],
        [50,88,51,87],[58,85,59,86],[59,53,60,52],[61,77,62,76],[68,43,69,44],
        [69,63,70,62],[70,36,71,35],[78,53,79,54],[79,85,80,84],[86,52,87,51],
        [67,55,68,54],[66,83,67,84],[38,55,39,56],[39,83,40,82],
        [81,41,82,40],[80,65,81,66],[56,41,57,42],[57,65,58,64],
    ]);
